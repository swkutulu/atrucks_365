...
сделал через COPY.
Посмотрел профайлером скртипт с pandas использует 350Mb (и от размера файлов зависит), c COPY 131 Mb.
...
- [ ] Makefile
- [x] pack into docker (такая конфигурация только для демонстрации и простоты, в некоторых местах не очень правильно)
- [ ] readme
- [ ] frontend tests
